...
//		this.goalSelector.add(5, new CollectBlockGoal(this, BlockTags.LOGS, 64));
//		this.goalSelector.add(6, new PlaceBlockGoal(this));
    this.goalSelector.add(3, new MoveToPlayerGoal());
  ...
  public class MoveToPlayerGoal extends NotAngryGoal {
    ...
    public boolean canBeeStart() {
      if (BeedeeEntity.this.player == null) {
        ...
        BeedeeEntity.this.player = BeedeeEntity.this.getWorld()
        ...
        BeedeeEntity.this.goalSelector.add(5, new CreateStructureGoal(BeedeeEntity.this, BeedeeEntity.this.player));
      }

      BeedeeEntity.this.playerPos = BeedeeEntity.this.player.getBlockPos();
      return BeedeeEntity.this.playerPos != null &&
              !playerPos.isWithinDistance(BeedeeEntity.this.getPos(), 10);
    }
